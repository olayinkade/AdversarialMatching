...
# files_in_dir = {'ADM.csv', 'Haven.csv', 'Oasis.csv', 'Tochka.csv', 'TPM.csv', 'Pandora.csv', 'TOM.csv', 'OutLaw.csv', 'EVO2.csv', 'NK.csv', 'Abraxas.csv', 'Dream.csv', 'Alpha.csv', 'RealDeal.csv', '1776.csv', 'SilkRoad.csv', 'Silkkitie.csv', 'Bungee54.csv', 'EVO.csv', 'BB.csv', 'Hansa.csv', 'Oxygen .csv', 'Alpaca.csv', 'Valhalla.csv', 'C9.csv', 'ME.csv', 'Agora.csv'}
files_in_dir = {'aaa.csv'}
root_dir = 'clean_gram'
